...
export default function AdminLoginPage() {
  ...
  const {
    ...
    defaultValues: { email: "sana.iqbal@wadud.app", password: "password" },
  });
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      toast.success("Welcome back", { description: "Redirecting to the admin console." });
  ...
  return (
    <div className="space-y-8">
      <div className="lg:hidden flex items-center gap-2.5">
        ...
        <span className="text-xl font-extrabold">Wadud Admin</span>
      </div>
